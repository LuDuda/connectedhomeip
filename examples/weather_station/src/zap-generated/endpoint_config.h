...
#define GENERATED_ATTRIBUTES                                                                                                            \
	{                                                                                                                               \
		...
		{ 0x00000000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_SIMPLE_DEFAULT(0x0000) }, /* identify              \
														  time                  \
														*/                      \
			...
			{ 0x00000017, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(40) }, /* BatteryApprovedChemistry                \
											      */                                        \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 16, 253 }, { ZAP_CLUSTER_INDEX(16), 2, 18 }, { ZAP_CLUSTER_INDEX(18), 2, 14 }, \
			{ ZAP_CLUSTER_INDEX(20), 2, 18 },                                                              \
	}
