...
Remember to replace _build-target_ with the buildtarget name of the Nordic Semiconductor's
kit you own.
...
_build-target_ replaced with the build target name of the Nordic Semiconductor's kit you own:
