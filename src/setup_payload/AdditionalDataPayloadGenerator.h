...
public:
     ...
     * @param uniqueIdBuffer null-terminated unique identifier buffer
     * @param uniqueIdBufferSize size of the unique identifier buffer supplied.
     ...
     *
     */
    CHIP_ERROR generateAdditionalDataPayload(uint16_t lifetimeCounter, const char * uniqueIdBuffer,
                                             size_t uniqueIdBufferSize, chip::System::PacketBufferHandle & bufferHandle,
     ...
     */
    CHIP_ERROR generateRotatingDeviceIdAsBinary(uint16_t lifetimeCounter, const char * uniqueIdBuffer,
                                                size_t uniqueIdBufferSize, MutableByteSpan & rotatingDeviceIdBuffer);
     ...
     *
     */
    CHIP_ERROR generateRotatingDeviceIdAsHexString(uint16_t lifetimeCounter, const char * uniqueIdBuffer,
                                                   size_t uniqueIdBufferSize, char * rotatingDeviceIdBuffer,
